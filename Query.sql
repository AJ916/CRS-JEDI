...
Error Code: 1452. Cannot add or update a child row: a foreign key constraint fails (`crs_pos_db`.`courseenrollment`, CONSTRAINT `courseenrollment_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`))
...
INSERT INTO Course (course_id, course_name, instructor_id, total_seats, available_seats, is_offered) VALUES
('C101', 'Introduction to Computer Science', 5, 10, 10, true),
('C102', 'Data Structures', 5, 10, 10, true),
('C103', 'Database Systems', 6, 10, 10, true),
('C104', 'Operating Systems', 6, 10, 10, true);
INSERT INTO Course (course_id, course_name, instructor_id, total_seats, available_seats, is_offered) VALUES
